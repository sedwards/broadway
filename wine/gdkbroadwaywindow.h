...
#define GDK_TYPE_BROADWAY_WINDOW              (wine_broadway_window_get_type ())
...
GType    wine_broadway_window_get_type          (void);

GDK_AVAILABLE_IN_ALL
guint32  wine_broadway_get_last_seen_time (GdkWindow       *window);
