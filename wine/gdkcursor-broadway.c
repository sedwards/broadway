 ...
 */
void
wine_broadway_cursor_display_finalize (GdkDisplay *display)
{
}

GdkCursor*
wine_broadway_display_get_cursor_for_type (GdkDisplay    *display,
...
void
wine_broadway_cursor_update_theme (GdkCursor *cursor)
{
  g_return_if_fail (cursor != NULL);
}

GdkCursor *
wine_broadway_display_get_cursor_for_surface (GdkDisplay *display,
...
GdkCursor*
wine_broadway_display_get_cursor_for_name (GdkDisplay  *display,
					   const gchar *name)
{
  GdkBroadwayCursor *private;
...
gboolean
wine_broadway_display_supports_cursor_alpha (GdkDisplay *display)
{
...
gboolean
wine_broadway_display_supports_cursor_color (GdkDisplay *display)
{
  g_return_val_if_fail (GDK_IS_DISPLAY (display), FALSE);
...
void
wine_broadway_display_get_default_cursor_size (GdkDisplay *display,
					       guint      *width,
					       guint      *height)
{
...
void
wine_broadway_display_get_maximal_cursor_size (GdkDisplay *display,
					       guint       *width,
					       guint       *height)
{
  g_return_if_fail (GDK_IS_DISPLAY (display));
