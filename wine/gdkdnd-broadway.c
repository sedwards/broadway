...
GdkDragContext *
wine_broadway_window_drag_begin (GdkWindow *window,
				 GdkDevice *device,
				 GList     *targets,
                                 gint       x_root,
                                 gint       y_root)
...
GdkDragProtocol
wine_broadway_window_get_drag_protocol (GdkWindow *window,
					GdkWindow **target)
{
...
void
wine_broadway_window_register_dnd (GdkWindow      *window)
{
}
...
void
wine_broadway_display_init_dnd (GdkDisplay *display)
{
}
