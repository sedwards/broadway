...
void
wine_broadway_screen_init_visuals (GdkScreen *screen)
{
...
gint
wine_broadway_screen_visual_get_best_depth (GdkScreen * screen)
{
  return GDK_BROADWAY_SCREEN (screen)->available_depths[0];
}

GdkVisualType
wine_broadway_screen_visual_get_best_type (GdkScreen * screen)
{
  return GDK_BROADWAY_SCREEN (screen)->available_types[0];
}

GdkVisual *
wine_broadway_screen_get_system_visual (GdkScreen * screen)
{
...
GdkVisual*
wine_broadway_screen_visual_get_best (GdkScreen * screen)
{
...
GdkVisual*
wine_broadway_screen_visual_get_best_with_depth (GdkScreen * screen,
						 gint depth)
{
  GdkBroadwayScreen *broadway_screen = GDK_BROADWAY_SCREEN (screen);
...
GdkVisual*
wine_broadway_screen_visual_get_best_with_type (GdkScreen * screen,
...
GdkVisual*
wine_broadway_screen_visual_get_best_with_both (GdkScreen * screen,
						gint          depth,
						GdkVisualType visual_type)
{
  GdkBroadwayScreen *broadway_screen = GDK_BROADWAY_SCREEN (screen);
...
void
wine_broadway_screen_query_depths  (GdkScreen * screen,
				    gint **depths,
				    gint  *count)
{
  GdkBroadwayScreen *broadway_screen = GDK_BROADWAY_SCREEN (screen);
...
void
wine_broadway_screen_query_visual_types (GdkScreen * screen,
...
GList *
wine_broadway_screen_list_visuals (GdkScreen *screen)
{
  GList *list;
  GdkBroadwayScreen *broadway_screen;
  guint i;
